...
public class InheritanceRun {
	...
	public static void main(String[] args) {
		...
		// 1. 3명의 학생 정보를 기록할 객체 배열 할당
		
		Student stdArr[] = new Student [3];
		
		stdArr[0] = new Student("강호동", 20, 200.0, 80.1, 1, "sbs");
		stdArr[1] = new Student("유재석", 21, 234.0, 30.2, 4, "ytn");
		stdArr[2] = new Student("신동엽", 24, 10.0, 80.1, 1, "kbs");
