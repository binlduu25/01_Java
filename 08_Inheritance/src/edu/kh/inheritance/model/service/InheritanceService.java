...
public class InheritanceService {
	...
	public void ex1() {
		...
		System.out.println( std2.getName() ); // 만약 super 생성자가 없었다면 name , age, nationality 는 JVM 초기값으로 지정되었을 것
	...
	public void ex2() {
		...
		// Student 와 Employee 각각 move 메소드가 존재하지 않지만 Person 의 move 메소드를 상속받아 사용 가능 
